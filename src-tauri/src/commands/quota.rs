...
#[tauri::command]
pub async fn get_quota(db: State<'_, Database>, account_id: String) -> Result<QuotaData, String> {
    // 网络请求放阻塞线程池，避免冻结主线程
    let (quota, today_tokens, today_calls) = {
        ...
        tauri::async_runtime::spawn_blocking(move || {
            ...
            Ok::<_, String>((quota, today_tokens, today_calls))
        })
        .await
