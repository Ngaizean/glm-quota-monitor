...
pub struct ToolUsageData {
    #[serde(rename = "x_time", default)]
    pub x_time: Vec<String>,
    #[serde(rename = "networkSearchCount", default)]
    pub network_search_count: Vec<Option<f64>>,
    #[serde(rename = "webReadMcpCount", default)]
    pub web_read_mcp_count: Vec<Option<f64>>,
    #[serde(rename = "zreadMcpCount", default)]
    pub zread_mcp_count: Vec<Option<f64>>,
    #[serde(rename = "totalUsage", default)]
...
pub struct TotalToolUsage {
    #[serde(rename = "totalNetworkSearchCount", default)]
    pub total_network_search_count: f64,
    #[serde(rename = "totalWebReadMcpCount", default)]
    pub total_web_read_mcp_count: f64,
    #[serde(rename = "totalZreadMcpCount", default)]
    pub total_zread_mcp_count: f64,
    #[serde(rename = "totalSearchMcpCount", default)]
    pub total_search_mcp_count: f64,
...
pub struct ToolDetail {
    ...
    #[serde(rename = "totalUsageCount", default)]
    pub total_usage_count: f64,
}
